...
modules/ts/opencv_ts_pch_dephelp.cxx: C:/opencv/sources/modules/ts/src/precomp.hpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=C:\opencv\MinGw_build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating opencv_ts_pch_dephelp.cxx"
	cd /d C:\opencv\MinGw_build\modules\ts && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo #include \"C:/opencv/sources/modules/ts/src/precomp.hpp\" > C:/opencv/MinGw_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d C:\opencv\MinGw_build\modules\ts && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo "int testfunction();" >> C:/opencv/MinGw_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d C:\opencv\MinGw_build\modules\ts && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo "int testfunction()" >> C:/opencv/MinGw_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d C:\opencv\MinGw_build\modules\ts && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo { >> C:/opencv/MinGw_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d C:\opencv\MinGw_build\modules\ts && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo "    return 0;" >> C:/opencv/MinGw_build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /d C:\opencv\MinGw_build\modules\ts && "C:\Program Files (x86)\CMake\bin\cmake.exe" -E echo } >> C:/opencv/MinGw_build/modules/ts/opencv_ts_pch_dephelp.cxx
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.obj: modules/ts/opencv_ts_pch_dephelp.cxx
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=C:\opencv\MinGw_build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.obj"
	cd /d C:\opencv\MinGw_build\modules\ts && C:\Qt\Qt5.7.0\Tools\mingw530_32\bin\g++.exe   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles\opencv_ts_pch_dephelp.dir\opencv_ts_pch_dephelp.cxx.obj -c C:\opencv\MinGw_build\modules\ts\opencv_ts_pch_dephelp.cxx
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.i: cmake_force
	...
	cd /d C:\opencv\MinGw_build\modules\ts && C:\Qt\Qt5.7.0\Tools\mingw530_32\bin\g++.exe  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E C:\opencv\MinGw_build\modules\ts\opencv_ts_pch_dephelp.cxx > CMakeFiles\opencv_ts_pch_dephelp.dir\opencv_ts_pch_dephelp.cxx.i
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.s: cmake_force
	...
	cd /d C:\opencv\MinGw_build\modules\ts && C:\Qt\Qt5.7.0\Tools\mingw530_32\bin\g++.exe  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S C:\opencv\MinGw_build\modules\ts\opencv_ts_pch_dephelp.cxx -o CMakeFiles\opencv_ts_pch_dephelp.dir\opencv_ts_pch_dephelp.cxx.s
...
lib/libopencv_ts_pch_dephelp.a: modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=C:\opencv\MinGw_build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ..\..\lib\libopencv_ts_pch_dephelp.a"
	cd /d C:\opencv\MinGw_build\modules\ts && $(CMAKE_COMMAND) -P CMakeFiles\opencv_ts_pch_dephelp.dir\cmake_clean_target.cmake
	cd /d C:\opencv\MinGw_build\modules\ts && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\opencv_ts_pch_dephelp.dir\link.txt --verbose=$(VERBOSE)
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/clean:
	cd /d C:\opencv\MinGw_build\modules\ts && $(CMAKE_COMMAND) -P CMakeFiles\opencv_ts_pch_dephelp.dir\cmake_clean.cmake
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/depend: modules/ts/opencv_ts_pch_dephelp.cxx
	$(CMAKE_COMMAND) -E cmake_depends "MinGW Makefiles" C:\opencv\sources C:\opencv\sources\modules\ts C:\opencv\MinGw_build C:\opencv\MinGw_build\modules\ts C:\opencv\MinGw_build\modules\ts\CMakeFiles\opencv_ts_pch_dephelp.dir\DependInfo.cmake --color=$(COLOR)
